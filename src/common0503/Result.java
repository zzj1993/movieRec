...
//		List<String> list = new ArrayList<String>();
		...
		PreparedStatement pst = conn.prepareStatement("select name from movie a,base1 b where a.id=b.movieid and userid=? order by timestamp desc");//select movieid,score from base1 where userid=?
		pst.setInt(1, userid);
